public class JavaTheHutt implements BotAPI
{
    ...
    JavaTheHutt(PlayerAPI me, PlayerAPI opponent, BoardAPI board, CubeAPI cube, MatchAPI match, InfoPanelAPI info) 
    {
        this.me = me;
    ...
    {
        return "JavaTheHutt"; // must match the class name
    }
